-- Liga o gasto Amazon Ads (azads_gastos) no gráfico diário por canal.
-- Base: definição VIVA de dre_diario_canais (pg_get_functiondef 03/08/2026, pós
-- tt_pago 20260724130001) — única mudança é o ramo az: az_ads + full join
-- (dia com ads e sem pedido não pode sumir do gráfico).
