...
- 🔺 **Régua das deduções dos NÃO-liquidados — DECISÃO DO LUCIANO (vale para TikTok E Shopee, é a mesma questão).** Contar dedução só quando liquida (versionado/doc) ou estimá-la enquanto não liquida? **⚠️ No TikTok há DRIFT VIVO não versionado:** o `tt_deducoes` do banco **estima** (comissão 6,0% / afiliados 2,1% / taxas 8,2% do `payment_total`, **frete de fora**); as taxas parecem calibradas sobre o **líquido** mas aplicadas sobre `payment_total` (~4% menor) → viés sistemático. A migration `20260710210001` e a doc dizem **só-liquidado**. Impacto (jul/2026): M.C. **+R$1.095 (só-liquidado) vs −R$746 (estima)** — diferença R$1.841. Na Shopee o mesmo está aberto (bruta conta os não-cancelados, mas dedução só existe para quem tem escrow). Decidir a régua, **versionar em migration** e alinhar CLAUDE.md/Notion nas duas plataformas.
